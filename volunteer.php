<?php
  ...
  $query = "SELECT * FROM `listing` WHERE Type LIKE 'Volunteer' ORDER BY Date";
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
          <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item" role="presentation"><a class="nav-link active" href="volunteer.php">Volunteer</a></li>
